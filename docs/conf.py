# -*- coding: utf-8 -*-
#
# pysatSpaceWeather documentation build configuration file, created by
...
# Directly import version from file
here = os.path.abspath(os.path.dirname(".."))
version_filename = os.path.join(here, 'pysatNASA/version.txt')
