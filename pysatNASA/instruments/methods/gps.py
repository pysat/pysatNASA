...
refs = {'mission': ' '.join(('Feltens J, Schaer S (1998) IGS Products for the',
        ...
        'roti15min_jpl': ' '.join(('1.	Pi, X., A. J. Mannucci, U. J.',
                                   ...
                                   'Lett., 24, 2283, 1997. 2.	Pi, X., F. J.',
                                   'Meyer, K. Chotoo, Anthony Freeman, R. G.',
                                   'Caton, and C. T. Bridgwood, Impact of',
                                   'ionospheric scintillation on Spaceborne',
                                   'SAR observations studied using GNSS,',
                                   'Proc. ION-GNSS, pp.1998-2006, 2012.'))}
