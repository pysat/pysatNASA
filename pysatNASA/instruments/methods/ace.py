...
refs = {'mission': ' '.join(('Stone, E., Frandsen, A., Mewaldt, R. et al.',
        ...
        'epam': ' '.join(('Gold, R., Krimigis, S., Hawkins, S. et al.',
                          'Electron, Proton, and Alpha Monitor on the Advanced',
                          'Composition Explorer spacecraft. Space Science',
                          'Reviews 86, 541–562 (1998).',
                          'https://doi.org/10.1023/A:1005088115759')),
        'mag': ' '.join(("Smith, C., L'Heureux, J., Ness, N. et al. The ACE",
                         "Magnetic Fields Experiment. Space Science Reviews",
                         "86, 613–632 (1998).",
                         "https://doi.org/10.1023/A:1005092216668")),
        'sis': ' '.join(('Stone, E., Cohen, C., Cook, W. et al. The Solar',
                         'Isotope Spectrometer for the Advanced Composition',
                         'Explorer. Space Science Reviews 86, 357–408 (1998).',
                         'https://doi.org/10.1023/A:1005027929871')),
        'swepam': ' '.join(('McComas, D., Bame, S., Barker, P. et al. Solar',
                            'Wind Electron Proton Alpha Monitor (SWEPAM) for',
                            'the Advanced Composition Explorer. Space Science',
                            'Reviews 86, 563–612 (1998).',
